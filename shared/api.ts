...
export const weatherAPI = {
  getWeather: function (latitude: number, longitude: number) {
    ...
    return axios.get(`/api/weather/data?longitude=126.9996417&latitude=37.56100278&temp=0&rainPer=100&weather=0&humidity=0&wind=0&pm10=0&pm25=0&corona=0&uv=0&pollenRisk=0&cold=0&asthma=0&foodPoison=0`)
  }
}